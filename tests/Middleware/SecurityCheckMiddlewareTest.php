...
class SecurityCheckMiddlewareTest extends TestCase
{
    ...
    /**
     * Test handle if ssl is enabled and ssl is not detected
     *
     * @return void
     */
    public function testHandleRequestWhenSslEnabledAndSslNotDetected(): void
    {
    ...
    /**
     * Test handle if ssl is enabled and ssl is detected
     *
     * @return void
     */
    public function testHandleRequestWhenSslEnabledAndSslDetected(): void
    {
        // configure mock expectations for this specific test
        $this->appUtilMock->expects($this->once())->method('isSSLOnly')->willReturn(true);
    ...
    /**
     * Test handle if the ssl is not enabled
     *
     * @return void
     */
    public function testHandleRequestWhenSslNotEnabled(): void
    {
        // configure mock expectations for this specific test
    ...
    /**
     * Test handle if the ip address is allowed
     *
     * @return void
     */
    public function testHandleRequestWhenIpAddressIsAllowed(): void
    {
    ...
    /**
     * Test handle if the ip address is not allowed
     *
     * @return void
     */
    public function testHandleRequestWhenIpAddressIsNotAllowed(): void
    {
        // mock allowed ip address
