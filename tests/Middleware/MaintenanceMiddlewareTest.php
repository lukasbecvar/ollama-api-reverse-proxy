...
class MaintenanceMiddlewareTest extends TestCase
{
    ...
    /**
     * Test handle if the maintenance mode is enabled
     *
     * @return void
     */
    public function testHandleRequestWhenMaintenanceModeEnabled(): void
    {
        // mock the app util
    ...
    /**
     * Test handle if the maintenance mode is disabled
     *
     * @return void
     */
    public function testHandleRequestWhenMaintenanceModeDisabled(): void
    {
        // mock the app util
