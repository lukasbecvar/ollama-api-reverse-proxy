...
class AccessTokenValidateMiddlewareTest extends TestCase
{
    ...
    /**
     * Test handle request when token is invalid
     *
     * @return void
     */
    public function testHandleRequestWhenTokenIsInvalid(): void
    {
        // testing request
    ...
    /**
     * Test handle request when token is valid
     *
     * @return void
     */
    public function testHandleRequestWhenTokenIsValid(): void
    {
        // testing request
        $request = new Request([], [], [], [], [], [], '{"email": "test@test.test", "password": "test"}');
        $request->setMethod('POST');
    ...
    /**
     * Test handle request when path is not API (should not validate token)
     *
     * @return void
     */
    public function testHandleRequestWhenPathIsNotApi(): void
    {
        // testing request
        $request = new Request([], [], [], [], [], []);
        $request->setMethod('POST');
